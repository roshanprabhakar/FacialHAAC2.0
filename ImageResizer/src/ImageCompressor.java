...
public abstract class ImageCompressor {
    ...
    protected ColorPoint[][][] CUBE = new ColorPoint[256][256][256];
    protected ArrayList<ColorPoint> points;
    protected BufferedImage image;
    protected BufferedImage compressed;
    protected Cluster uniqueColors;
    ...
    public abstract void generateReport(); //generate a measure of success
}
